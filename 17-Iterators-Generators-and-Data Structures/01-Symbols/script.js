// Symbols - primitive data types
// can be used to create unique identifiers for objects
...
console.log(sym.description, sym1.description, sym2.description);
...
// user.id = 2; // cannot reasign value
